...
void mdns::engine::ui::renderPingTool(PingTool::PingStats const& stats,
                                     ...
                                     std::function<void()> onStop)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(cardBg.x + 0.05f, cardBg.y + 0.05f, cardBg.z + 0.05f, 1.0f));
    ...
    ImGui::BeginChild("PingOutput", ImVec2(ImGui::GetContentRegionAvail().x - 16.0f, ImGui::GetContentRegionAvail().y - 16.0f), false, ImGuiWindowFlags_NoScrollbar);
    ImGui::PopStyleColor(2);
    ImGui::PopStyleVar(2);
